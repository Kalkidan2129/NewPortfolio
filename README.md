...
I am a data analyst skilled in transforming complex raw data into clear, actionable insights using tools like Python, Power BI, and modern data warehousing platforms. My expertise spans ETL processes, data enrichment, and building dashboards that support forecasting, performance analysis, and strategic decision-making. I focus on leveraging data science and business intelligence techniques to help organizations in dynamic industries make confident, data-driven choices.
