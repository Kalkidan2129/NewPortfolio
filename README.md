...
I am a data analyst skilled in transforming complex, raw datasets into clear, actionable insights using tools like Python, Power BI, and Microsoft Fabric. My expertise includes data extraction, transformation, and loading (ETL), building unified data models, and developing interactive dashboards that support forecasting and performance analysis. I focus on enabling data-driven decision-making through business intelligence solutions, particularly in industries such as telecommunications and finance.
